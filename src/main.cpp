...
const string strMessageMagic = "FineCoin Signed Message:\n";
...
// Premine: First 10 block are 660,000,000 RDD (3% of the total coin)
nSubsidy = 660000000 * COIN;
} else if (nHeight < 20000) {
// Bonus reward for block 10-19,999 of 600,000 coins
nSubsidy = 600000 * COIN;
} else if (nHeight < 40000) {
// Bonus reward for block 20,000 - 39,999 of 400,000 coins
nSubsidy = 400000 * COIN;
} else if (nHeight < 60000) {
// Bonus reward for block 40,000 - 59,999 of 350,000 coins
...
static const int64 nTargetTimespan = 730 * 24 * 60 * 60; // FineCoin: 1 days
static const int64 nTargetSpacing = 60; // FineCoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal finecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FineCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcb9d14b90010d3b19eab50c79ff3f0d053f85abb7b8e74364e8006338bb94a3a");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "New Dundalk Tesco open for business";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1410779976; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1318652;

        if (fTestNet)
        {
            block.nTime    = 1410518394;
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x1ce937c492038caae8eedd1e4656ded539bc33f41a270f7ea33c9ccf422b4bc8"));
